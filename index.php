...
<body>
  ...
  <div class="panel" id="panel">
    ...
    <hr class="break">
      <form  action="index.php" method="POST" name="summoner-search" id="summoner-search" onsubmit="return formValidation()">
      ...
      <?php
        if(isset($_POST['summoner-submit']) && $responseKeys["success"] == true){
          ...
          $purchaseData = $dbHandler->SearchName($summonerName, $summonerRegion);
          ...
          if(empty($purchaseData) || $purchaseData['sold'] == 1){               
            ...
            if($accountData['success']){
              ...
              if($matchData['success']){
                ...
                if($summonerRegion == "KR"){
                  echo '<p><b>Links: </b>' . $uggLink . '</p>';
                } else {
                ...
                if($daysUntilExpiry < 0){
                  ...
                  if($summonerRegion == "KR"){
                    echo 'Register '  . "<a href=\"https://signup.kr.riotgames.com/\" target=\"_blank\">[HERE]</a>"; 
                  } else {
            ...
            // Update 'Searches'
            $update = $dbHandler->UpdateSearches($summonerName, $summonerRegion);
